...
my_wmi_obj = wmi.WMI(computer='192.168.68.223', user='ec1', password='tplink', find_classes=False)  # Win10专业版物理机，连接成功！
# my_wmi_obj = wmi.WMI(computer='192.168.48.130', user='lynulyq', password='tplink', find_classes=False)  # VMWare里的Win7企业版，连接成功！
