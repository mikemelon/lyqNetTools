...
def check_google_chrome_by_reg():
    ...
    try:
        ...
        print('Exception occured while check_google_chrome_by_reg:{}'.format(ex) )


def check_google_chrome_by_reg2():
    # 另外一种查找注册表的方式，注册表位置不一样，见：https://blog.csdn.net/u013314786/article/details/122497226
    try:
        py_hkey_obj2 = win32api.RegOpenKeyEx(win32con.HKEY_LOCAL_MACHINE,
        ...
        for n in range(sub_key_nums):
            ...
            if 'Chrome' in cur_key_name:
                ...
                py_hkey_obj3 = win32api.RegOpenKeyEx(win32con.HKEY_LOCAL_MACHINE,
        ...
        print('Exception occured while check_google_chrome_by_reg2:{}'.format(ex) )
